...
#!perl
#line 29
    eval 'exec \Users\Cosmic\Documents\GitHub\fullstack-user-system\xampp\perl\bin\perl.exe -S $0 ${1+"$@"}'
...
my $perlpath = '\Users\Cosmic\Documents\GitHub\fullstack-user-system\xampp\perl\bin\perl.exe';
