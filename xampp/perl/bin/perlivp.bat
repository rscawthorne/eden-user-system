...
#!perl
#line 29
    eval 'exec \Users\Cosmic\Documents\GitHub\eden_user_system\xampp\perl\bin\perl.exe -S $0 ${1+"$@"}'
...
my $perlpath = '\Users\Cosmic\Documents\GitHub\eden_user_system\xampp\perl\bin\perl.exe';
