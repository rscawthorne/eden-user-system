...
if "%PHPBIN%" == "" set PHPBIN=\Users\Cosmic\Documents\GitHub\fullstack-user-system\xampp\php\.\php.exe
if not exist "%PHPBIN%" if "%PHP_PEAR_PHP_BIN%" neq "" goto USE_PEAR_PATH
GOTO RUN
:USE_PEAR_PATH
set PHPBIN=%PHP_PEAR_PHP_BIN%
:RUN
"%PHPBIN%" "\Users\Cosmic\Documents\GitHub\fullstack-user-system\xampp\php\phpunit" %*
