...
if ('\Users\Cosmic\Documents\GitHub\eden_user_system\xampp\php\pear ' != '@'.'include_path'.'@ ') {
    ini_set('include_path', trim('\Users\Cosmic\Documents\GitHub\eden_user_system\xampp\php\pear '). PATH_SEPARATOR .  get_include_path());
    $raw = false;
} else {
